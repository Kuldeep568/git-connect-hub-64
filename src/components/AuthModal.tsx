        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          {!isLogin && (
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 border-border/50 focus:border-coral"
                required
              />
            </div>
          )}
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={handleInputChange}
              className="pl-10 pr-10 h-12 border-border/50 focus:border-coral"
              required
            />
            <button
              type="button"
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button 
              type="button" 
              variant="outline" 
              className="h-12 border-border/50 hover:bg-muted"
            >
